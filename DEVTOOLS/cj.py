...
with open("stream.wpl") as file:
    for line in file:
        ...
        if dae_name in ["c_apple_md_ingame","c_apple_md_ingame_2", "c_apple_md_ingame01", "c_fern_md_ingame", "c_fern_md_ingame_2", "c_fern_md_ingame_3", "elm_md_ingame", "elm_md_ingame_2", "h_c_md_f_ingame", "h_c_md_f_ingame_2", "l_p_sap_ingame_2", "liveoak_md_ingame", "liveoak_md_ingame_2", "londonp_md_ingame", "londonp_md_ingame_2", "pinoak_md_ingame", "pinoak_md_ingame_2", "w_birch_md_ingame", "w_birch_md_ingame_2", "w_birch_md_ingame2", "w_r_cedar_md_ingame"]:
