...
filename = input("Enter the name of the file (without the .idx extension): ")
filename += ".idx"
...
for line in lines:
    ...
    obj1.name = obj1.name + '_a3500'
    
    # Create a plane and name it with the suffix '_a130'
    bpy.ops.mesh.primitive_plane_add(location=(0, 0, 0))
    plane1 = bpy.context.selected_objects[0]
    plane1.name = plane1.name + '_a150'
    ...
    if os.path.exists(os.path.join(path, model2 + '.dae')):
        ...
        obj2.name = obj2.name + '_a550'
    else:
        # If it doesn't exist, create a plane and name it with the suffix '_a250'
        bpy.ops.mesh.primitive_plane_add(location=(0, 0, 0))
        obj2 = bpy.context.selected_objects[0]
        obj2.name = obj2.name + '_a150'
    ...
    # Make 'start01' the parent of 'base00' and the three objects
    for obj in [obj1, obj2, plane1]:
        obj1.parent = start
        obj2.parent = start
        plane1.parent = start
    start.parent = base
